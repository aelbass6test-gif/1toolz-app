...
const CreateStorePage = lazyWithRetry(() => import('./components/CreateStorePage'));
const ManageSitesPage = lazyWithRetry(() => import('./components/ManageSitesPage'));
const Dashboard = lazyWithRetry(() => import('./components/Dashboard'));
const OrdersList = lazyWithRetry(() => import('./components/OrdersList'));
const ProductsPage = lazyWithRetry(() => import('./components/ProductsPage'));
const CustomersPage = lazyWithRetry(() => import('./components/CustomersPage'));
const WalletPage = lazyWithRetry(() => import('./components/WalletPage'));
const SettingsPage = lazyWithRetry(() => import('./components/SettingsPage'));
const StorefrontPage = lazyWithRetry(() => import('./components/StorefrontPage'));
const CheckoutPage = lazyWithRetry(() => import('./components/CheckoutPage'));
const OrderSuccessPage = lazyWithRetry(() => import('./components/OrderSuccessPage'));
const StoreCustomizationPage = lazyWithRetry(() => import('./components/StoreCustomizationPage'));
const ShippingPage = lazyWithRetry(() => import('./components/ShippingPage'));
const ConfirmationQueuePage = lazyWithRetry(() => import('./components/ConfirmationQueuePage'));
const AbandonedCartsPage = lazyWithRetry(() => import('./components/AbandonedCartsPage'));
const DiscountsPage = lazyWithRetry(() => import('./components/DiscountsPage'));
const ReviewsPage = lazyWithRetry(() => import('./components/ReviewsPage'));
const CollectionsPage = lazyWithRetry(() => import('./components/CollectionsPage'));
const ProductOptionsPage = lazyWithRetry(() => import('./components/ProductOptionsPage'));
const ExpensesPage = lazyWithRetry(() => import('./components/ExpensesPage'));
const MarketingPage = lazyWithRetry(() => import('./components/MarketingPage'));
...
const MaintenancePage = lazyWithRetry(() => import('./src/pages/MaintenancePage'));
const EmployeeLayout = lazyWithRetry(() => import('./components/EmployeeLayout'));
const EmployeeDashboardPage = lazyWithRetry(() => import('./components/EmployeeDashboardPage'));
const EmployeeAccountSettingsPage = lazyWithRetry(() => import('./components/EmployeeAccountSettingsPage'));
const EmployeeActivityPage = lazyWithRetry(() => import('./components/EmployeeActivityPage'));
const AccountSettingsPage = lazyWithRetry(() => import('./components/AccountSettingsPage'));
const CollectionsReportPage = lazyWithRetry(() => import('./components/CollectionsReportPage'));
const ActivityLogsPage = lazyWithRetry(() => import('./components/ActivityLogsPage'));
const SuppliersPage = lazyWithRetry(() => import('./components/SuppliersPage'));
const PartnersPage = lazyWithRetry(() => import('./components/PartnersPage'));
const PartnerProfilePage = lazyWithRetry(() => import('./components/PartnerProfilePage'));
const PartnerPortal = lazyWithRetry(() => import('./components/PartnerPortal'));
const ExcelReconciliationPage = lazyWithRetry(() => import('./components/ExcelReconciliationPage'));
const PagesManager = lazyWithRetry(() => import('./components/PagesManager'));
const PaymentSettingsPage = lazyWithRetry(() => import('./components/PaymentSettingsPage'));
...
const InventoryTransfers = lazyWithRetry(() => import('./components/InventoryTransfers'));
const OrderReturnsPage = lazyWithRetry(() => import('./components/OrderReturnsPage'));
const PurchaseReturnsPage = lazyWithRetry(() => import('./components/PurchaseReturnsPage'));
const POSPage = lazyWithRetry(() => import('./components/POSPage'));
const CashManagement = lazyWithRetry(() => import('./components/CashManagement'));
const CreateOrderPage = lazyWithRetry(() => import('./components/CreateOrderPage'));
const EditOrderPage = lazyWithRetry(() => import('./components/EditOrderPage'));
...
const TreasuryPage = lazyWithRetry(() => import('./components/TreasuryPage'), 'TreasuryPage');
const DomainSettingsPage = lazyWithRetry(() => import('./components/DomainSettingsPage'), 'DomainSettingsPage');
const SharedReportView = lazyWithRetry(() => import('./components/SharedReportView'), 'SharedReportView');
        ...
        <Suspense fallback={<GlobalLoader />}>
            <Routes>
                ...
                <Route path="/store/:storeId" element={
                    ...
                    <Route path="cash-management" element={<CashManagement settings={pageProps.settings} updateSettings={pageProps.setSettings} currentUser={currentUser} treasury={pageProps.treasury} setTreasury={pageProps.setTreasury} wallet={pageProps.wallet} setWallet={pageProps.setWallet} orders={pageProps.orders} />} />
                    ...
                    <Route path="whatsapp" element={<WhatsAppPage {...pageProps} onRefresh={() => activeStoreId ? refreshStoreData(activeStoreId) : Promise.resolve()} />} />
