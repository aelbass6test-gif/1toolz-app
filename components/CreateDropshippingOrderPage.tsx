...
import { DropshippingOrderForm, NewOrderState } from './DropshippingOrderForm';
...
interface CreateDropshippingOrderPageProps {
    orders: Order[];
...
const CreateDropshippingOrderPage: React.FC<CreateDropshippingOrderPageProps> = ({ 
    orders, 
    setOrders, 
    settings, 
    setSettings,
  ...
  const isMaintenance = orderToAdd.orderType === 'maintenance';
    ...
    return (
        <>
            <DropshippingOrderForm 
                orderData={newOrder}
                setOrderData={setNewOrder}
                settings={settings}
                onAddOrder={handleAddOrder}
                onCancel={() => navigate(activeStore ? `/store/${activeStore.id}/dropshipping` : '/dropshipping')}
            />
...
export default CreateDropshippingOrderPage;
