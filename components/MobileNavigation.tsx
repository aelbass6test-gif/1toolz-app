...
const MobileNavigation: React.FC<MobileNavigationProps> = ({ activeStoreId }) => {
  const storePrefix = activeStoreId ? `/store/${activeStoreId}` : '';
