    ...
    <body>
        <div class="policy-container">
            ...
            <div class="header-charter">
                <div class="brand-box">
                    <h2 class="brand-title">تجارة وتسويق الكتروني عبده ميديا</h2>
            ...
            <div class="document-title">
                ...
                <p>دليل حماية رأس المال وضوابط توزيع السيولة والأرباح - تجارة وتسويق الكتروني عبده ميديا</p>
            </div>
            ...
            <p style="font-size: 11px; color: var(--slate-700); line-height: 1.6; text-align: justify; margin-bottom: 20px;">
                ...
                <strong>تجارة وتسويق الكتروني عبده ميديا</strong>. تم تصميم القواعد المحاسبية التالية لضمان الحفاظ المستمر على تدفق المخزون وسلامة الهيكل المالي للمتجر وتجنب تآكل رأس المال تحت أي ظرف من الظروف.
            </p>
            ...
            <div class="policy-section">
                ...
                <p style="font-size: 11px; color: var(--slate-700); line-height: 1.6; text-align: justify; margin: 0;">
                    تلتزم <strong>تجارة وتسويق الكتروني عبده ميديا</strong> بإدارة الحملات الإعلانية الممولة وبناء قنوات المبيعات واستهداف العملاء لرفع معدل دوران رأس المال بالمتجر، بينما يلتزم الشركاء بتمويل شراء مخزون البضاعة بالجملة وتجميد تكلفة البضائع فور تحصيلها لضمان تغذية الرفوف، والامتناع التام عن سحب أو تجميد أي مبالغ من التحصيلات إلا بعد غلق الدفاتر الدورية واحتساب صافي الأرباح قانونياً.
                </p>
            </div>

            <!-- Section 5: Dissolution Policy -->
            <div class="policy-section" style="page-break-inside: avoid; margin-top: 25px;">
                <div class="section-header">
                    <span class="section-icon">⚖️</span>
                    <span>المادة السادسة: سياسة وآليات فض الشراكة وتصفية المستحقات</span>
                </div>
                <p style="font-size: 11px; color: var(--slate-700); line-height: 1.6; text-align: justify; margin: 0 0 12px 0;">
                    في حال اتخاذ الشركاء قراراً بفض الشراكة أو تصفية العمل المشترك بالمتجر، يتم اعتماد أحد المسارات القانونية والمحاسبية التالية لضمان توزيع الحقوق والالتزامات وسداد المستحقات دون أي نزاعات:
                </p>
                <div class="grid-pillars" style="margin-bottom: 0;">
                    <div class="pillar-card" style="border-top-color: #dc2626;">
                        <span class="pillar-title" style="color: #991b1b;">🚪 1. التخارج بالتصفية الودية للمخزون</span>
                        <span class="pillar-text">
                            يتم إيقاف شراء أي بضاعة جديدة فوراً. تستمر الحملات التسويقية لتسييل (بيع) كامل المخزون الحالي بالأسعار التشغيلية، ثم تسدد مديونيات الموردين ومصاريف الشحن المعلقة، ويوزع النقد المتبقي بالكامل (رأس المال المودع + صافي الأرباح المتبقية) على الشركاء بعد تصفية وطرح أي مسحوبات شخصية سابقة لكل منهما.
                        </span>
                    </div>

                    <div class="pillar-card" style="border-top-color: #2563eb;">
                        <span class="pillar-title" style="color: #1e40af;">🤝 2. استحواذ أحد الشركاء (شراء الحصة)</span>
                        <span class="pillar-text">
                            يقوم الشريك الراغب في الاستمرار بشراء حصة الشريك المتخارج. يتم جرد المخزون الحالي الفعلي وتقييمه بسعر تكلفة الجملة الأصلية (دون إضافة هامش ربح مستقبلي)، ويقوم الشريك المستمر بدفع قيمة حصة الطرف المتخارج كاش (رأسماله المودع + نصيبه من الأرباح مخصوماً منها مسحوباته)، لتنتقل ملكية المتجر والمخزون له بالكامل.
                        </span>
                    </div>

                    <div class="pillar-card" style="border-top-color: #84cc16;">
                        <span class="pillar-title" style="color: #3f6212;">📦 3. تقسيم البضائع والمخزون عينياً</span>
                        <span class="pillar-text">
                            في حال تعذر تسييل البضائع كاش أو الاستحواذ، يتم جرد مخزن المتجر بالكامل وحصر كمياته، ويتم تقسيم البضائع الفعلية (عينياً) بين الشركاء بالتساوي أو بنسبة الشراكة لتصبح بضاعة خاصة لكل طرف يتصرف بها بمعرفته، مع تصفية الحساب المالي النقدي المتبقي بالخزنة (الأرباح والمسحوبات) كاش طبقاً لتقرير الميزانية النهائي.
                        </span>
                    </div>

                    <div class="pillar-card" style="border-top-color: #7c3aed;">
                        <span class="pillar-title" style="color: #5b21b6;">⚙️ 4. دور عبده ميديا في فض الشراكة</span>
                        <span class="pillar-text">
                            تلتزم <strong>تجارة وتسويق الكتروني عبده ميديا</strong> بإيقاف الحملات الإعلانية فوراً عند استلام طلب الفض الرسمي، وحصر التسويات الإعلانية ومصاريف الشحن المعلقة لشركات الشحن، وتصدير ميزانية ختامية وتقرير مالي نهائي مختوم يوضح الدورة بالكامل والمسحوبات وحساب التصفية لتسهيل القسمة الودية.
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="signature-area" style="margin-top: 35px;">
                <div class="sig-box">
                    <div class="sig-title">إشراف وتوثيق: تجارة وتسويق الكتروني عبده ميديا</div>
